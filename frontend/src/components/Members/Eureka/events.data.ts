...
export const eventsData: Event[] = [
  ...
  },
  {
    ...
    name: "Rapid Rush",
    description:
      "A fast-paced, team-based eco adventure race where teams of 2–5 members compete to complete a series of fun, environment-themed challenges across multiple stations. Teams start at the Start Point and must clear all eco-stations and return as quickly as possible while collecting signatures and avoiding time penalties.",
    highlights: [
  ...
  },
  {
    ...
    name: "SYNERGY",
    description:
      "A hands-on technical competition for teams of four students that blends electronics puzzles, component identification, quizzes, and practical circuit building under time and resource constraints. The event tests technical knowledge, teamwork, and innovation, leading to an exciting final IoT-based car race.",
    highlights: [
  ...
  },
  {
    ...
    name: "Cash or Crash",
    description:
      "A high-energy, strategy-based tech challenge where teams compete using virtual money, bidding on hidden questions from mixed categories. With no prerequisites required, the event tests quick thinking, smart bidding, teamwork, and decision-making under pressure.",
    highlights: [
  ...
  },
  {
    ...
    name: "CLASH TO BID",
    description:
      "An exciting two-round team event that blends cricket knowledge with strategy and decision-making. Teams first compete in a quiz-based screening round to earn their way into a Mini IPL–style auction, where smart bidding and team planning decide the winners.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "A vibrant and creative event that celebrates traditional art, color harmony, and cultural expression. Participants design beautiful rangoli patterns using colors, flowers, or eco-friendly materials, showcasing creativity, precision, and artistic skills within a given time.",
    highlights: [
  ...
  },
  {
    ...
    name: "EUREKA Night",
    description:
      "The grand cultural night celebrating achievements, creativity, and campus unity with performances, awards, and celebrations. Featuring cultural performances, student ramp walk, and student achievement video presentation.",
    highlights: [
    ...
    registrationLink:
      "https://docs.google.com/forms/d/e/1FAIpQLSe5Jd3xOlp9NZYpQwk3894SATuE0uTVL4dZu2yLfimwHpd5lQ/viewform?usp=header",
    venue: "Kreeda Vedika",
