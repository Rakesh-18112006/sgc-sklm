...
useEffect(() => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const headerHeight =
        document.querySelector(".mobile-header")?.clientHeight || 60;
  ...
  return (
    <>
      ...
      <div
        className={`mobile-ticker md-hidden lg-hidden ${
      ...
      >
        ...
        <div className="nav-section">
          ...
          <ul className="nav-list">
            ...
            <li>
              {" "}
              <Link to="/clubs" onClick={toggleNav}>
                <span className="flex gap-2">
            ...
            <li>
              {" "}
              <Link to="/members" onClick={toggleNav}>
                <span className="flex gap-2">
